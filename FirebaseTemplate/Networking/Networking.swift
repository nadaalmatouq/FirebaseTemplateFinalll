...
class Networking// : Networkable
{
    ...
    static func DeleteItem( inCollection COLLECTION_NAME: String, withDocumentId documentId: String = "",  success: @escaping ()-> Void, fail: @escaping (Error?)->())
    {
        
        print("⚙️ Deleting item  of type: at collection: \"\(COLLECTION_NAME)\" ...")
